...
# execute(["scrapy", "crawl", "journal"])
# execute(["scrapy", "crawl", "xuezhehomepage"])
...
# execute(["scrapy", "crawl", "jiechu_update"])
# execute(["scrapy", "crawl", "jiechuqingnian"])
# execute(["scrapy", "crawl", "innojoy_zhuanli"])
# execute(["scrapy", "crawl", "cnki_abstract"])
# execute(["scrapy", "crawl", "cnki_zhuanli"])
